...
object DrawerLayoutHelper {
  ...
  fun setDrawerLeftEdgeSize(activity: Activity?,
    ...
    try {
      ...
      val leftDraggerField = drawerLayout.javaClass.superclass.getDeclaredField("mLeftDragger")
      ...
      //更改其属性 mPeekRunnable
      val leftCallbackField = drawerLayout.javaClass.superclass.getDeclaredField("mLeftCallback")
